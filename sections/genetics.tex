...
\subsubsection{Example of a genome}
...
\paragraph{The fourth hox gene} clusters based on the third cluster gene on all clusters based on the second cluster gene.
The target neuron is $i_1$.
\begin{figure}[H]
    \centering
