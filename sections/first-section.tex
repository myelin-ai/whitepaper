...
\subsubsection{The scale of abstraction}
...
be defined arbitrarily. We choose the well-known example of the first-generation perceptron for this task.
...
abstract away the very thing that gave rise to the mind in the first place~(To do: Cite mind as evolution for locomotion). 
